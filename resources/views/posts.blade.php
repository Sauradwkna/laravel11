      ...
      <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0">
          <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            @forelse ($posts as $post)
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 flex flex-col min-h-[300px]">
                    ...
                    <div class="flex justify-between items-center mt-auto">
                          <a href="/posts?author={{ $post->author->username }}">
                            <div class="flex items-center space-x-3">
                              <img class="w-7 h-7 rounded-full" src="{{ $post->author->image }}" alt="{{ $post->author->name }}" />
